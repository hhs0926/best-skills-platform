...
<head>
    ...
    <title><?php echo e($title ?? 'Best Skills'); ?> - Skills 社交生态平台</title>
        ...
        <div class="max-w-7xl mx-auto flex items-center justify-between">
            <div class="flex items-center gap-8">
                ...
                <div class="hidden md:flex items-center gap-6 text-sm text-gray-400">
                    <a href="<?php echo e(route('home')); ?>" class="hover:text-white transition <?php echo e(request()->is('/') ? 'text-white' : ''); ?>">首页</a>
                    <a href="<?php echo e(route('skills.index')); ?>" class="hover:text-white transition <?php echo e(request()->is('skills*') ? 'text-violet-400' : ''); ?>">技能库</a>
                    <a href="<?php echo e(route('community')); ?>" class="hover:text-white transition">社区</a>
                    <a href="<?php echo e(route('exchange')); ?>" class="hover:text-white transition">交换</a>
                </div>
            </div>
            <div class="flex items-center gap-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="text-sm text-gray-300 hover:text-white transition"><?php echo e(Auth::user()->name); ?></a>
                ...
                <?php else: ?>
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="glow-btn text-sm text-white px-4 py-2 rounded-lg hover:opacity-90 transition">注册</a>
...
<?php /**PATH C:\Users\Administrator\WorkBuddy\20260401194012\best-skills-platform\resources\views\layouts\app.blade.php ENDPATH**/ ?>