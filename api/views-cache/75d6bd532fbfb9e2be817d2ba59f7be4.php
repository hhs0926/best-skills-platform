...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <p class="mt-6 text-center text-sm text-gray-400">
                    已有账号？
                    <a href="<?php echo e(route('login')); ?>" class="font-semibold text-cyan-400 hover:text-cyan-300 transition-colors">
                        立即登录
                    </a>
                </p>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\Administrator\WorkBuddy\20260401194012\best-skills-platform\resources\views\auth\register.blade.php ENDPATH**/ ?>